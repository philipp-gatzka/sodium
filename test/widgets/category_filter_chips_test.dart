...
void main() {
  group('CategoryFilterChips', () {
    testWidgets(
      'should not show anything when categories is empty',
      (tester) async {
    ...
    testWidgets(
      'should show All chip as selected when selectedCategory is null',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
    ...
    testWidgets(
      'should show category chip as selected when it matches',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
    ...
    testWidgets(
      'should call onCategorySelected with null when All is tapped',
      (tester) async {
    ...
    testWidgets(
      'should have correct item count including All chip',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
